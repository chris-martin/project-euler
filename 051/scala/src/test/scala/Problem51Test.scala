class Problem51Test extends org.scalatest.FreeSpec {

  "RichIterable.groupByMultiple" in {

    import Problem51.RichIterable
  ...
  "RichSeq.replacementPossibilities" in {

    import Problem51.RichSeq
  ...
  "RichString.starPossibilities" in {

    import Problem51.RichString
